...
const ServicePage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>
          Vivo Service Centers in Vidarbha | Authorized Repair & Support | Vivo
          Nagpur
        </title>
        <meta
          name="description"
          content="Find official Vivo service centers in Nagpur, Amravati, Akola & across Vidarbha region. Get professional smartphone repairs, warranty services & technical support."
        />
        <meta
          name="keywords"
          content="Vivo service center Nagpur, Vivo repair center, Vivo warranty service, smartphone repair Nagpur, Vivo technical support Vidarbha"
        />
      </Head>

      {/* Add structured data for service centers */}
      <Script id="service-centers-data" type="application/ld+json">
        {`
          {
            "@context": "https://schema.org",
            "@type": "Organization",
            "name": "Vivo Service Centers in Vidarbha",
            "url": "https://www.vivonagpur.com/service",
            "logo": "https://www.vivonagpur.com/assets/vivo.png",
            "department": [
              ${Object.entries(storesData).map(([city, centers]) =>
                centers
                  .map(
                    (center) => `{
      ...
      <div className="bg-gray-100 min-h-screen">
        ...
        <main>
          <h1 className="sr-only">
            Official Vivo Service Centers in Vidarbha Region
          </h1>
