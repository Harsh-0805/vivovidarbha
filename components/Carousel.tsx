import prod from "@/public/assets/prod1.png";

export const HeroSection: React.FC = () => {
  return (
    <section className="relative h-[600px] bg-cover bg-center bg-[url('../public/assets/prod1.png')]">
      ...
      <div className="absolute inset-0 flex flex-col justify-center pl-32">
        ...
        <p className="mt-2 text-lg font-medium text-[#a7a9ad]">
          Multifocal Portrait | 5500mAh
        </p>
        <button className="bg-blue-600 text-white py-3 w-[171px] px-6 justify-between rounded-lg mt-4 hover:bg-blue-700 flex items-center">
          Learn More
      ...
      <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
        <button className="bg-blue-600 text-white h-12 w-12 rounded-full">
          &larr;
        </button>
      </div>
