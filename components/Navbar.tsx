...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex justify-between items-center py-4 px-8 bg-white shadow-md">
      ...
      <div className="hidden lg:flex space-x-16 font-normal text-gray-900">
        <ul className="flex space-x-8">
          ...
          <li>
            <a href="/careers" className="hover:text-blue-500 nav-link">
              Careers
            </a>
          </li>
          <li>
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="user-logo hidden lg:block">
          <svg
            width="28"
            height="28"
            viewBox="0 0 28 28"
